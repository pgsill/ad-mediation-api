...
This api receives applications and networks, and the relation between them have a score, this score is used to mediate and return an ordered list of one applcation networks ordered by the score.
